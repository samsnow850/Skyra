...
import { ActivityIndicator, DeviceEventEmitter, FlatList, SafeAreaView, StatusBar, StyleSheet, Text, TouchableOpacity, View } from 'react-native';
                ...
                <View style={[styles.expandedContainer, { backgroundColor: theme.card }]}>
                  {loadingWeather === item ? (
                    ...
                    <>
                      ...
                      <Text style={[styles.weatherDetail, { color: theme.text }]}>Wind: {weatherData[item].wind.speed} m/s</Text>
                    </>
                  ) : weatherData[item] && weatherData[item].error ? (
